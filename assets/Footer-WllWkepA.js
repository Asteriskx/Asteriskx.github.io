import{a as l,p as s,q as Z}from"./chunk-LFPYN7LY-CkqpkPzF.js";import{_ as E}from"./preload-helper-BXl3LOEh.js";const T=8,u=8,A=.5,ss=450,L=110,S=L*(T-1)+ss+150,f=150;function ns(e){const n=100/T,r=n*e,c=n*(e+1);return`polygon(${r-u-A}% 0%, ${c-u+A}% 0%, ${c+u+A}% 100%, ${r+u-A}% 100%)`}function G({logos:e,intervalMs:n}){const[r,c]=l.useState(0),[o,t]=l.useState(null),[i,h]=l.useState(!1),j=l.useRef(r);return j.current=r,l.useEffect(()=>{const a=setInterval(()=>{const d=(j.current+1)%e.length;t(d),h(!1),setTimeout(()=>c(d),S),setTimeout(()=>h(!0),S+50),setTimeout(()=>t(null),S+50+f)},n);return()=>clearInterval(a)},[e.length,n]),s.jsxs("div",{className:"slash-logo-wrap",children:[s.jsx("img",{src:e[r],alt:"logo",className:"slash-logo-base"}),o!==null&&s.jsx("div",{className:`slash-strips-wrapper${i?" leaving":""}`,style:{"--fadeout-ms":`${f}ms`},children:Array.from({length:T},(a,d)=>s.jsx("div",{style:{position:"absolute",inset:0,clipPath:ns(d)},children:s.jsx("div",{className:"slash-strip-inner",style:{position:"absolute",inset:0,backgroundImage:`url(${e[o]})`,backgroundSize:"cover",backgroundPosition:"center",animationDelay:`${d*L}ms`}})},d))})]})}const es=["/assets/image/logo-v2.png","/assets/image/logo-v3.png","/assets/image/logo-v4.png","/assets/image/logo-v5.png"];function rs(){return s.jsx("div",{className:"logo-slash-demo",children:s.jsx(G,{logos:es,intervalMs:2400})})}const ls=["/assets/image/logo-v2.png","/assets/image/logo-v3.png","/assets/image/logo-v4.png","/assets/image/logo-v5.png","/assets/image/logo-v6.png"];function p(e,n,r,c){const[o,t]=l.useState(""),i=l.useRef(!1),h=l.useRef(c);return h.current=c,l.useEffect(()=>{if(!r||i.current)return;t(""),i.current=!1;let j=0,a=null;const d=setInterval(()=>{t(e.slice(0,j+1)),j++,j>=e.length&&(clearInterval(d),i.current=!0,a=setTimeout(()=>h.current(),180))},n);return()=>{clearInterval(d),a&&clearTimeout(a)}},[r,e,n]),o}function ds(){const[e,n]=l.useState(0),r=()=>n(C=>C+1),c=p("name",85,e>=1,r),o=p("たっけん",75,e>=2,r),t=p("@あすた",75,e>=3,r),i=p("role",85,e>=4,r),h=p("Chief Engineer, Embedded Software.",50,e>=5,r),j=p("info",85,e>=6,r),a=p("C / C# / Rust を中心に、組み込みシステムから",32,e>=7,r),d=p("デスクトップアプリ・言語設計まで幅広く手がけています。",32,e>=8,r),g=p("skills",85,e>=9,r),[x,D]=l.useState(!1),[N,H]=l.useState(!1),[X,Q]=l.useState(!1),[J,V]=l.useState(!1),[W,$]=l.useState(!1);return l.useEffect(()=>{if(e<10)return;const C=setTimeout(()=>D(!0),80),q=setTimeout(()=>H(!0),220),K=setTimeout(()=>Q(!0),360),Y=setTimeout(()=>V(!0),500),z=setTimeout(()=>$(!0),640);return()=>{clearTimeout(C),clearTimeout(q),clearTimeout(K),clearTimeout(Y),clearTimeout(z)}},[e]),l.useEffect(()=>{const C=setTimeout(()=>n(1),500);return()=>clearTimeout(C)},[]),s.jsx("div",{className:"hero-terminal",children:s.jsxs("div",{className:"term-body",children:[s.jsxs("div",{className:"term-commands",children:[s.jsxs("span",{className:"term-line",children:[s.jsx("span",{className:"term-prompt",children:"$"}),s.jsx("span",{className:"term-cmd",children:c}),e<2&&s.jsx("span",{className:"term-blink",children:"▌"})]}),e>=2&&s.jsx("div",{className:"term-result",children:s.jsxs("span",{className:"term-result-line",children:[s.jsx("span",{children:o}),s.jsx("span",{className:"term-name-accent",children:t})]})}),e>=4&&s.jsxs("span",{className:"term-line",children:[s.jsx("span",{className:"term-prompt",children:"$"}),s.jsx("span",{className:"term-cmd",children:i}),e===4&&s.jsx("span",{className:"term-blink",children:"▌"})]}),e>=5&&s.jsx("div",{className:"term-result",children:s.jsx("span",{className:"term-result-line term-role-val",children:h})}),e>=6&&s.jsxs("span",{className:"term-line",children:[s.jsx("span",{className:"term-prompt",children:"$"}),s.jsx("span",{className:"term-cmd",children:j}),e===6&&s.jsx("span",{className:"term-blink",children:"▌"})]}),e>=7&&s.jsxs("div",{className:"term-result",children:[s.jsx("span",{className:"term-result-line",children:a}),e>=8&&s.jsx("span",{className:"term-result-line",children:d})]}),e>=9&&s.jsxs("span",{className:"term-line",children:[s.jsx("span",{className:"term-prompt",children:"$"}),s.jsx("span",{className:"term-cmd",children:g}),e===9&&s.jsx("span",{className:"term-blink",children:"▌"})]}),e>=10&&s.jsxs("div",{className:"term-result",children:[x&&s.jsxs("span",{className:"term-skill-row",children:[s.jsx("span",{className:"term-sk-cat",children:"Systems   "}),s.jsx("span",{className:"term-sk-sep",children:" │ "}),s.jsx("span",{className:"term-sk-val",children:"C · C++ · Assembly · Rust"})]}),N&&s.jsxs("span",{className:"term-skill-row",children:[s.jsx("span",{className:"term-sk-cat",children:"App       "}),s.jsx("span",{className:"term-sk-sep",children:" │ "}),s.jsx("span",{className:"term-sk-val",children:"C# · Java · Python"})]}),X&&s.jsxs("span",{className:"term-skill-row",children:[s.jsx("span",{className:"term-sk-cat",children:"Web/Script"}),s.jsx("span",{className:"term-sk-sep",children:" │ "}),s.jsx("span",{className:"term-sk-val",children:"TypeScript · Node.js · Ruby · VBA · HTML"})]}),J&&s.jsxs("span",{className:"term-skill-row",children:[s.jsx("span",{className:"term-sk-cat",children:"Graphics  "}),s.jsx("span",{className:"term-sk-sep",children:" │ "}),s.jsx("span",{className:"term-sk-val",children:"Processing · p5.js · Three.js"})]}),W&&s.jsxs("span",{className:"term-skill-row",children:[s.jsx("span",{className:"term-sk-cat",children:"Infra     "}),s.jsx("span",{className:"term-sk-sep",children:" │ "}),s.jsx("span",{className:"term-sk-val",children:"Linux (Ubuntu · Arch · CentOS) · NW L1–L4 · サーバ構築"})]})]}),s.jsx("div",{className:"term-divider"}),s.jsxs("div",{className:"hero-tags",children:[s.jsx("span",{className:"htag",children:"Systems"}),s.jsx("span",{className:"htag",children:"Language Design"}),s.jsx("span",{className:"htag",children:"Desktop Apps"}),s.jsxs("span",{className:"htag-pair",children:[s.jsx("span",{className:"htag htag-graphics",children:"Graphics"}),s.jsx("span",{className:"htag htag-infra",children:"Infra"})]})]}),s.jsxs("a",{href:"#work",className:"hero-cta",children:["Work ",s.jsx("span",{className:"cta-arrow",children:"↓"})]})]}),s.jsx("div",{className:"term-logo",children:s.jsx(G,{logos:ls,intervalMs:5e3})})]})})}function cs(){const[e,n]=l.useState(0);return s.jsxs("div",{className:"hero-terminal-demo",children:[s.jsx(ds,{},e),s.jsx("button",{className:"hero-terminal-demo-replay",onClick:()=>n(r=>r+1),"aria-label":"再生",children:"[ replay ]"})]})}const is={title:"ポートフォリオを全面刷新した話",date:"2026-03-25",description:"SSH ログイン風アニメーション・Three.js パーティクル背景・OGP 対応まで。2026年3月に行った全面リニューアルの記録。",tags:["Web","React"]};function y(e){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.h1,{children:"ポートフォリオを全面刷新した話"}),`
...
`,s.jsx(n.p,{children:"とりあえず今は満足している。"})]})}function hs(e={}){const{wrapper:n}=e.components||{};return n?s.jsx(n,{...e,children:s.jsx(y,{...e})}):y(e)}const ts=Object.freeze(Object.defineProperty({__proto__:null,default:hs,frontmatter:is},Symbol.toStringTag,{value:"Module"}));function m({items:e}){return s.jsxs("nav",{className:"blog-toc","aria-label":"目次",children:[s.jsx("span",{className:"blog-toc-header",children:"// table of contents"}),s.jsx("ol",{className:"blog-toc-list",children:e.map((n,r)=>s.jsxs("li",{className:"blog-toc-item",children:[s.jsxs("span",{className:"blog-toc-num",children:[String(r+1).padStart(2,"0"),"."]}),s.jsx("a",{href:n.href,className:"blog-toc-link",children:n.label})]},n.href))})]})}const js={title:"React Router v7 で SSG して GitHub Pages にデプロイする",date:"2026-03-26",description:"ssr: false + prerender で完全静的化し、GitHub Actions で gh-pages ブランチに自動デプロイするまでの手順書。カスタムドメイン・OGP 静的注入・動的ルートの列挙も含む。",tags:["Web","React"]};function R(e){const n={a:"a",code:"code",h1:"h1",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.h1,{children:"React Router v7 で SSG して GitHub Pages にデプロイする"}),`
`,s.jsx(n.p,{children:"このサイト（asteriskx.net）の構築時に整理した手順をそのまま残しておく。"}),`
`,s.jsx(n.p,{children:"未来の自分が同じ構成を作るときのリファレンスとして。"}),`
`,s.jsx(m,{items:[{label:"プロジェクト作成",href:"#s1"},{label:"SSG に切り替える（react-router.config.ts）",href:"#s2"},{label:"動的ルートを列挙する（ブログ記事など）",href:"#s3"},{label:"静的 HTML に CSS / OGP を直接注入する（vite.config.ts）",href:"#s4"},{label:"MDX を使う場合（ブログ記事）",href:"#s5"},{label:"GitHub Actions でデプロイする",href:"#s6"},{label:"GitHub Pages のブランチ設定（初回のみ）",href:"#s7"},{label:"カスタムドメインの DNS 設定",href:"#s8"},{label:"CNAME ファイルの対応",href:"#s9"},{label:"ハマりポイントまとめ",href:"#s-tips"}]}),`
`,s.jsx(n.hr,{}),`
...
`]}),`
`]})]})}function Cs(e={}){const{wrapper:n}=e.components||{};return n?s.jsx(n,{...e,children:s.jsx(_,{...e})}):_(e)}const us=Object.freeze(Object.defineProperty({__proto__:null,default:Cs,frontmatter:Ns},Symbol.toStringTag,{value:"Module"})),As={title:"UDS / DTC 解説メモ — 車載診断の仕組み",date:"2026-03-28",description:"車載 ECU 開発の実務知見をもとに UDS / DTC を整理。通信モデル・主要サービス・DTC 構造・ステータスバイト・FreezeFrame・診断フローまで。",tags:["組み込み","車載"]};function M(e){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.h1,{children:"UDS / DTC 解説メモ — 車載診断の仕組み"}),`
`,s.jsxs(n.blockquote,{children:[`
...
`]}),`
`,s.jsx(m,{items:[{label:"UDS とは",href:"#s1"},{label:"UDS の通信モデル",href:"#s2"},{label:"主要 UDS サービス一覧",href:"#s3"},{label:"DTC とは",href:"#s4"},{label:"DTC ステータスバイト",href:"#s5"},{label:"DTC の検出と記録フロー",href:"#s6"},{label:"FreezeFrame / Snapshot",href:"#s7"},{label:"UDS 0x19 サブファンクション",href:"#s8"},{label:"実務での診断フロー",href:"#s9"}]}),`
`,s.jsx(n.hr,{}),`
...
`]}),`
`]})]})}function bs(e={}){const{wrapper:n}=e.components||{};return n?s.jsx(n,{...e,children:s.jsx(M,{...e})}):M(e)}const Ds=Object.freeze(Object.defineProperty({__proto__:null,default:bs,frontmatter:As},Symbol.toStringTag,{value:"Module"})),Ss={title:"CCP / XCP 解説メモ — 車載 ECU 計測・キャリブレーション通信",date:"2026-03-31",description:"車載 ECU 開発の実務知見をもとに CCP / XCP を整理。プロトコル概要・パケット構造・DAQ / ODT・キャリブレーション・A2L ファイル・主要コマンドまで。",tags:["組み込み","車載"]};function I(e){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.h1,{children:"CCP / XCP 解説メモ — 車載 ECU 計測・キャリブレーション通信"}),`
`,s.jsxs(n.blockquote,{children:[`
`,s.jsxs(n.p,{children:[`これまでの車載 ECU 開発を通じて得た知見を整理した備忘録。
CAN / CAN FD の仕組みについては`,s.jsx(n.a,{href:"/blog/20260328-can-canfd-protocol",children:"こちらの記事"}),`を参照。
UDS / DTC については`,s.jsx(n.a,{href:"/blog/20260328-uds-dtc-vehicle-diagnostics",children:"こちらの記事"}),"を参照。"]}),`
`]}),`
`,s.jsx(m,{items:[{label:"CCP / XCP とは",href:"#s1"},{label:"プロトコルスタック上の位置",href:"#s2"},{label:"CCP の概要",href:"#s3"},{label:"XCP の概要・パケット構造",href:"#s4"},{label:"DAQ（データ計測）",href:"#s5"},{label:"ODT と DAQ リスト",href:"#s6"},{label:"キャリブレーション",href:"#s7"},{label:"A2L ファイル",href:"#s8"},{label:"主要コマンド一覧",href:"#s9"},{label:"実務での使い方",href:"#s10"}]}),`
`,s.jsx(n.hr,{}),`
...
`]}),`
`]})]})}function Ts(e={}){const{wrapper:n}=e.components||{};return n?s.jsx(n,{...e,children:s.jsx(I,{...e})}):I(e)}const Es=Object.freeze(Object.defineProperty({__proto__:null,default:Ts,frontmatter:Ss},Symbol.toStringTag,{value:"Module"})),fs={title:"FY2025 振り返り — 火消しと昇格と、あとちょっとした隠居宣言",date:"2026-03-31",description:"年中火消し・新規 PJ 参画・チーフエンジニア昇格。色々あった FY2025 の個人的な振り返り。あと後輩への隠居宣言（冗談）。",tags:["雑記"]};function P(e){const n={blockquote:"blockquote",h1:"h1",hr:"hr",p:"p",strong:"strong",...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.h1,{children:"FY2025 振り返り — 火消しと昇格と、あとちょっとした隠居宣言"}),`
`,s.jsx(m,{items:[{label:"FY2025 を一言で表すと",href:"#s1"},{label:"火消し屋の一年",href:"#s2"},{label:"新規 PJ 参画",href:"#s3"},{label:"チーフエンジニア昇格",href:"#s4"},{label:"後輩よ、頼んだ",href:"#s5"},{label:"FY2026 に向けて",href:"#s6"}]}),`
`,s.jsx(n.hr,{}),`
...
FY2026 もよろしくお願いします。`}),`
`]})]})}function ys(e={}){const{wrapper:n}=e.components||{};return n?s.jsx(n,{...e,children:s.jsx(P,{...e})}):P(e)}const Rs=Object.freeze(Object.defineProperty({__proto__:null,default:ys,frontmatter:fs},Symbol.toStringTag,{value:"Module"})),Os={title:"JTAG / RAM 解析入門 — 組み込みデバッグの武器を知る",date:"2026-04-12",description:"組み込み開発で欠かせない JTAG の仕組みと RAM 解析の基礎を入門者向けに解説。TAP コントローラー・デバッグ動作原理から OpenOCD / J-Link / TRACE32 / Renesas E1/E2 のツール比較・実践フローまで。",tags:["組み込み","デバッグ"]};function k(e){const n={blockquote:"blockquote",code:"code",h1:"h1",h3:"h3",h4:"h4",hr:"hr",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.h1,{children:"JTAG / RAM 解析入門 — 組み込みデバッグの武器を知る"}),`
`,s.jsxs(n.blockquote,{children:[`
...
`]}),`
`,s.jsx(m,{items:[{label:"JTAG とは",href:"#s1"},{label:"JTAG のアーキテクチャ",href:"#s2"},{label:"バウンダリスキャン",href:"#s3"},{label:"デバッガとしての JTAG",href:"#s4"},{label:"RAM 解析とは",href:"#s5"},{label:"主要ツール紹介",href:"#s6"},{label:"実践フロー",href:"#s7"},{label:"よくある躓きポイント",href:"#s8"}]}),`
`,s.jsx(n.hr,{}),`
...
`]}),`
`]})]})}function _s(e={}){const{wrapper:n}=e.components||{};return n?s.jsx(n,{...e,children:s.jsx(k,{...e})}):k(e)}const Ms=Object.freeze(Object.defineProperty({__proto__:null,default:_s,frontmatter:Os},Symbol.toStringTag,{value:"Module"})),Is={title:"近況報告 — DGX Spark を思い切って導入した話と、夏バテ注意報",date:"2026-07-13",description:"相変わらず仕事はドタバタ。7月に入ってNVIDIA DGX Spark ×2とEIZOウルトラワイドモニターを導入。構築の進捗と、夏バテへの注意喚起。",tags:["雑記"]};function F(e){const n={a:"a",h1:"h1",hr:"hr",p:"p",strong:"strong",...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.h1,{children:"近況報告 — DGX Spark を思い切って導入した話と、夏バテ注意報"}),`
`,s.jsx(m,{items:[{label:"相変わらずのドタバタ",href:"#s1"},{label:"今月の大きな買い物",href:"#s2"},{label:"DGX Spark 構築、順調です",href:"#s3"},{label:"夏バテ注意報",href:"#s4"}]}),`
`,s.jsx(n.hr,{}),`
`,s.jsx("h2",{id:"s1",children:"相変わらずのドタバタ"}),`
`,s.jsx(n.p,{children:`気づけばもう 7 月。
相変わらず仕事は火消しの日々でドタバタしている。
毎年この時期は特に落ち着かない。`}),`
`,s.jsx(n.p,{children:`そんな中でも、ちょっとした息抜きというか、自分への投資というか。
7 月に入ってから思い切った買い物をした。
今日はその近況報告。`}),`
`,s.jsx(n.hr,{}),`
`,s.jsx("h2",{id:"s2",children:"今月の大きな買い物"}),`
`,s.jsxs(n.p,{children:[s.jsx(n.strong,{children:"NVIDIA DGX Spark"}),"（",s.jsx(n.a,{href:"https://www.nvidia.com/en-us/products/workstations/dgx-spark/",children:"公式ページ"}),"）を 2 台、そして ",s.jsx(n.strong,{children:"EIZO のビジネス向けウルトラワイド曲面モニター FlexScan EV3895-AMZWB"}),"（",s.jsx(n.a,{href:"https://www.eizoglobal.com/products/flexscan/ev3895/index.html",children:"公式ページ"}),"）を購入した。"]}),`
`,s.jsx(n.p,{children:`正直、かなり思い切った出費。
それでも「今やるべき」という直感があった。`}),`
`,s.jsx(n.p,{children:`DGX Spark は個人でローカル完結の LLM 推論環境を組みたくて導入した。
2 台構成にしたのは、後述するモデルの使い分けと、将来的なクラスタ実験を見据えて。`}),`
`,s.jsx(n.p,{children:`EIZO のウルトラワイド曲面モニターは、作業効率を上げる目的で導入。
超横長の画面にターミナルとブラウザとエディタを並べられるのは、想像以上に快適。`}),`
`,s.jsx(n.hr,{}),`
`,s.jsx("h2",{id:"s3",children:"DGX Spark 構築、順調です"}),`
`,s.jsx(n.p,{children:"構築は現在進行中だが、ここまでのところ順調に進んでいる。"}),`
`,s.jsx(n.p,{children:`2 台の DGX Spark で役割を分けて、Qwen3.6-35B や Gemma 4（26B / 31B）といった複数の大規模言語モデルを使い分けられる環境を組んだ。
...
`,s.jsx(n.p,{children:`自宅の LAN 環境からなら、PC でもスマホでもブラウザ経由でアクセス可能。
ソファでくつろぎながら自宅の GPU にちょっとした処理を投げられるのは、なかなか気持ちがいい。`}),`
`,s.jsx(n.p,{children:`おまけとして、この Claude Code からも自宅の DGX Spark 上のモデル（Gemma 4）に接続できるように設定してみた。
普段は Claude のクラウド LLM を使っているが、環境変数を切り替えるだけでローカルの自前モデルとやり取りできる状態になっている。
実際にディレクトリ一覧を取得させるような簡単なツール呼び出しまでは動作確認済み。`}),`
`,s.jsx(n.p,{children:`2 台は ConnectX-7 という NIC の専用ケーブルですでに直結済み。
...
そのあたりはまた進捗があれば記事にする。`}),`
`,s.jsx(n.hr,{}),`
`,s.jsx("h2",{id:"s4",children:"夏バテ注意報"}),`
`,s.jsx(n.p,{children:"そして最後に、身も蓋もない話。"}),`
`,s.jsx(n.p,{children:s.jsx(n.strong,{children:"暑さに負けて、夏バテ気味。"})}),`
`,s.jsx(n.p,{children:`仕事のドタバタと、おうち AI 環境構築の作業とで、気づいたら食欲も落ちていた。
涼しい部屋にこもりっぱなしで運動不足にもなりがち。`}),`
`,s.jsx(n.p,{children:`この時期、同じような状態の人は多いと思う。
水分と塩分、そして睡眠はしっかり確保してほしい。
無理は禁物。`}),`
`,s.jsx(n.p,{children:"お互い、この夏を乗り切りましょう。"})]})}function Ps(e={}){const{wrapper:n}=e.components||{};return n?s.jsx(n,{...e,children:s.jsx(F,{...e})}):F(e)}const ks=Object.freeze(Object.defineProperty({__proto__:null,default:Ps,frontmatter:Is},Symbol.toStringTag,{value:"Module"})),Fs={title:"はじめまして。",date:"2026-03-21",description:"ブログ的な何か。技術的なメモや開発日記（不定期）を書いていきます。",tags:["雑記"]};function v(e){const n={code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.h1,{children:"これ is 何?"}),`
...
`})})]})}function vs(e={}){const{wrapper:n}=e.components||{};return n?s.jsx(n,{...e,children:s.jsx(v,{...e})}):v(e)}const Us=Object.freeze(Object.defineProperty({__proto__:null,default:vs,frontmatter:Fs},Symbol.toStringTag,{value:"Module"}));function ws(e){const[n,r]=l.useState(""),c=e.join(",");return l.useEffect(()=>{const t=c.split(",").map(h=>document.getElementById(h)).filter(Boolean);function i(){if(window.scrollY+window.innerHeight>=document.body.scrollHeight-60&&t.length>0){r(t[t.length-1].id);return}let j="";for(const a of t)window.scrollY>=a.offsetTop-120&&(j=a.id);r(j)}return window.addEventListener("scroll",i,{passive:!0}),i(),()=>window.removeEventListener("scroll",i)},[c]),n}const U="ぽーとふぉりおっぽいもの",B=Object.assign({"../content/blog/20260325-portfolio-renewal.mdx":ts,"../content/blog/20260326-react-router-v7-ssg-github-pages.mdx":as,"../content/blog/20260326-threejs-particle-bg.mdx":gs,"../content/blog/20260328-can-canfd-protocol.mdx":us,"../content/blog/20260328-uds-dtc-vehicle-diagnostics.mdx":Ds,"../content/blog/20260331-ccp-xcp-calibration.mdx":Es,"../content/blog/20260331-fy2025-retrospective.mdx":Rs,"../content/blog/20260412-jtag-ram-analysis-tools.mdx":Ms,"../content/blog/20260713-近況報告-dgxsparkと夏バテ.mdx":ks,"../content/blog/hello-world.mdx":Us}),b=Object.keys(B).length,w=Object.values(B).map(e=>e.frontmatter?.date??"").sort((e,n)=>n.localeCompare(e))[0]??null;function Bs(){const[e,n]=l.useState(""),[r,c]=l.useState(!1),[o,t]=l.useState(!1),i=ws(["about","work","blog","contact"]),h=Z(),j=h.pathname==="/",a=h.pathname.startsWith("/blog"),d=x=>j?`#${x}`:`/#${x}`;l.useEffect(()=>{let x=null;const D=setTimeout(()=>{let N=0;x=setInterval(()=>{n(U.slice(0,N+1)),N++,N>=U.length&&clearInterval(x)},90)},200);return()=>{clearTimeout(D),x&&clearInterval(x)}},[]),l.useEffect(()=>{const x=()=>t(window.scrollY>40);return window.addEventListener("scroll",x,{passive:!0}),()=>window.removeEventListener("scroll",x)},[]);const g=()=>c(!1);return s.jsxs(s.Fragment,{children:[s.jsxs("header",{className:`header${o?" scrolled":""}`,id:"header",children:[s.jsxs("a",{href:j?"#about":"/",className:"header-name",children:[s.jsx("span",{className:"header-prompt",children:"›"}),s.jsx("span",{children:e}),s.jsx("span",{className:"header-cursor"})]}),s.jsxs("nav",{className:"header-nav",children:[s.jsxs("a",{href:d("about"),className:i==="about"?"active":"",children:[s.jsx("span",{className:"nav-num",children:"01."}),"About"]}),s.jsxs("a",{href:d("work"),className:i==="work"?"active":"",children:[s.jsx("span",{className:"nav-num",children:"02."}),"Work"]}),s.jsxs("a",{href:d("blog"),className:i==="blog"||a?"active":"",children:[s.jsx("span",{className:"nav-num",children:"03."}),"Blog",b>0&&s.jsx("span",{className:"nav-blog-badge",children:b}),w&&s.jsx("span",{className:"nav-blog-date",children:w})]}),s.jsxs("a",{href:d("contact"),className:i==="contact"?"active":"",children:[s.jsx("span",{className:"nav-num",children:"04."}),"Contact"]})]}),s.jsxs("button",{className:"menu-toggle","aria-label":"メニュー",onClick:()=>c(x=>!x),children:[s.jsx("span",{}),s.jsx("span",{})]})]}),r&&s.jsx("div",{className:"mobile-menu-veil",onClick:g}),s.jsx("div",{className:`mobile-menu${r?" open":""}`,children:s.jsxs("nav",{children:[s.jsxs("a",{href:d("about"),className:"mobile-link",onClick:g,children:[s.jsx("span",{className:"nav-num",children:"01."}),"About"]}),s.jsxs("a",{href:d("work"),className:"mobile-link",onClick:g,children:[s.jsx("span",{className:"nav-num",children:"02."}),"Work"]}),s.jsxs("a",{href:d("blog"),className:"mobile-link",onClick:g,children:[s.jsx("span",{className:"nav-num",children:"03."}),"Blog",b>0&&s.jsx("span",{className:"nav-blog-badge",children:b})]}),s.jsxs("a",{href:d("contact"),className:"mobile-link",onClick:g,children:[s.jsx("span",{className:"nav-num",children:"04."}),"Contact"]})]})})]})}function Hs(){const[e,n]=l.useState(!1);return l.useEffect(()=>{const r=()=>n(window.scrollY>400);return window.addEventListener("scroll",r,{passive:!0}),()=>window.removeEventListener("scroll",r)},[]),s.jsx("button",{className:`back-to-top${e?" visible":""}`,"aria-label":"トップに戻る",onClick:()=>window.scrollTo({top:0,behavior:"smooth"}),children:"[ ↑ top ]"})}function Xs({isHome:e=!1}){const n=r=>e?`#${r}`:`/#${r}`;return s.jsxs("footer",{className:"footer",children:[s.jsx("span",{className:"footer-copy",children:"© 2018–2026 Asteriskx"}),s.jsxs("nav",{className:"footer-nav","aria-label":"Footer navigation",children:[s.jsx("a",{href:n("about"),children:"about"}),s.jsx("a",{href:n("work"),children:"work"}),s.jsx("a",{href:"/blog",children:"blog"}),s.jsx("a",{href:n("contact"),children:"contact"})]})]})}export{Hs as B,Xs as F,Bs as H,Us as _,ks as a,Ms as b,Rs as c,Es as d,Ds as e,us as f,gs as g,as as h,ts as i,ds as j};
